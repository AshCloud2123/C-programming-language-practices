...
Programmer:  Write a program that takes Month and Date and prints the Zodiac
sign corresponding to Month (1=January, 12=December) and
Days/Date. Use the following table;
...
int main()
{
    //declare the variables in which we store the data
    int day;
    int month;

    //prompts the user to input the date
    printf("Enter the date(1 to 31): ");
    scanf("%d", &day);
